...
WBpmEditor::WBpmEditor(const QString& group, QWidget* pParent)
    ...
    m_pClickOverlay = std::make_unique<QPushButton>(this);
    ...
    m_pTapSelectButton = std::make_unique<QPushButton>(this);
    ...
    m_pEditSelectButton = std::make_unique<QPushButton>(this);
    ...
    m_pSelectWidget = std::make_unique<QWidget>(this);
    m_pSelectWidget->installEventFilter(this);
    auto pSelectLayout = new QHBoxLayout();
    ...
    m_pSelectWidget->setLayout(pSelectLayout);

    m_pTapButton = std::make_unique<TapPushButton>(this);
    ...
    m_pEditBox = std::make_unique<QDoubleSpinBox>(this);
