...
/// Custom style for QGroupBox that renders the 'enabled' checkbox as an arrow icon
/// ArrowDown/ArrowRight icon and skips drawing the groupbox frame when the box is collapsed.
